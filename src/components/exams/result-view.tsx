  ...
  return <main className="result-page">
    ...
    <section className="result-container">
      <div className="result-grid">
        <article className="result-card"><h2>영역별 점수</h2><div className="section-bars">{result.sections.map(section => <div key={section.code}><div><span>{section.title}</span><b>{section.earnedScore}<small> / {section.maxScore}</small></b></div><i><em style={{ width: `${section.percentage}%` }} /></i></div>)}</div></article>
